...
<script>
	...
	$('#manage-user').submit(function(e){
		...
		start_loader()
		$.ajax({
			url:_base_url_+'classes/Users.php?f=psave',
			...
			success:function(resp){
				if(resp==1){
					...
					$('#msg').html('<div class="alert alert-danger">User not exist</div>')
					end_loader()
				}else{
					$('#msg').html('<div class="alert alert-danger">Username not exist</div>')
					end_loader()
				}
			}
		})
